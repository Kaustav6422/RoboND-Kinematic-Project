...
def test_code(test_case):
    ...
    # Error correction to align DH parameters with urdf file
    ...
    # More information can be foud in Inverse Kinematics with KUKA KR210
    ...
    your_wc = [WC[0], WC[1], WC[2]] #[1,1,1] # <--- Load your calculated WC values in this array
    your_ee = [FK[0,3],FK[1,3],FK[2,3]] #[1,1,1] # <--- Load your calculated end effector value from your forward kinematics
    ########################################################################################
